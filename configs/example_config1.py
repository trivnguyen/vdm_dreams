...
def get_config():
    ...
    data.dataset_name = "mw_zooms-wdm-galprop/nmax50-vmaxtilde-pad-v3"
    data.n_particles = 50  # Select the first n_particles particles
    data.n_features = 8  # Select the first n_features features
    data.n_pos_features = 3
    data.n_vel_features = 3
    data.n_mass_features = 1
    ...
    data.conditioning_parameters = [
        "center_subhalo_mvir", "halo_mvir", "inv_wdm_mass", "log_sn1", "log_sn2", "log_agn1"]
